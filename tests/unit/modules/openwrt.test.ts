...
import {
  ...
  parseSystemInfo,
  uciQuote
} from '../../../modules/openwrt/main/parse'
import {
  buildFirewallPlan,
  buildPppoeUci,
  effectivePppoeChunkSize
} from '../../../modules/openwrt/main/uci'
import {
...
} from '../../../modules/openwrt/main/binding'
import { findSequenceRange } from '../../../modules/openwrt/main/pppoe'
import { buildFastSweepCommand } from '../../../modules/openwrt/main/service'
import { selectOptions } from '../../../modules/openwrt/main/options'
import { DEFAULT_RULES } from '../../../modules/openwrt/main/config'
import type { IpRule, Lease, RouterModel } from '../../../modules/openwrt/main/types'
...
describe('OpenWRT parsers', () => {
  ...
  it('scopes router-side rate aggregation to exact managed sequence ranges', () => {
    ...
    expect(command).toContain("echo '===RULES_OK===1'")
    expect(command).toContain("echo '===RULES_OK===0'")
    expect(
