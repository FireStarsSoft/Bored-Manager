...
/**
 * Project additions: `success` and `warning`, for the health states this app
 * reports constantly (a service that is up, a disk that is nearly full). They
 * follow the same tinted shape as upstream's `destructive`.
 */
