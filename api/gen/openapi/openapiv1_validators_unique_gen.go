...
// validateUniqueReleaseArtifact checks for duplicate items using hash-based detection.
func validateUniqueReleaseArtifact(items []ReleaseArtifact) (err error) {
	if len(items) <= 1 {
		return nil
	}
